    ...
    <div className="min-h-screen bg-gradient-to-br from-sage-100 via-emerald-50 to-eucalyptus-100 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/80 backdrop-blur-2xl rounded-3xl border border-white/50 shadow-2xl p-8 md:p-12">
          ...
          <div className="mb-8">
            <p className="text-xs font-medium text-emerald-700 uppercase tracking-widest mb-2">Sign In</p>
            <p className="text-stone-600 text-sm">Access your diagnostic dashboard</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="text-center pt-4">
              <Link href="/signup" className="text-sm text-stone-600 hover:text-stone-900 transition-colors">
